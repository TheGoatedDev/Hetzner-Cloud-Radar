...
export function StockCell({
    ...
    if (stock === "not-offered") {
        return (
            <td className="px-0 py-1 text-center align-middle sm:px-2">
    ...
    function scheduleOpen() {
        ...
        if (openTimer.current || panelRef.current?.matches(":popover-open"))
            return;
                    ...
                    {dispatchFamily ? (
                        ...
                        >
                            ...
                            <p className="text-2xs text-ink-faint leading-relaxed">
                                Whole {familyLabel} line @ selected DCs, not{" "}
                                {type} alone.
                            </p>
