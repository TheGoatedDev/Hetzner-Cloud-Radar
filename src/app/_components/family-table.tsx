      ...
      <tbody>
        {family.types.map((t, i) => (
          <tr key={t.code} className={i > 0 ? "border-t border-hairline" : ""}>
            <th
              scope="row"
              className="px-1 py-1.5 text-left align-middle font-medium tracking-[0.04em] text-ink sm:px-2"
            >
            ...
            <td className="hidden px-2 py-1.5 text-left align-middle text-xs text-ink-soft sm:table-cell">
