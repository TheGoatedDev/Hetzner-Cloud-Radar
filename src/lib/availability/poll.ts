...
export async function pollAvailability() {
    ...
    try {
        ...
        const fetchedLocations = new Map<
            string,
            ReturnType<typeof readLocation>
        >();
        ...
        for (const stored of storedServerTypes) {
            ...
            await db
                ...
                .set({
                    raw: {
                        ...(stored.raw && typeof stored.raw === "object"
                            ? stored.raw
                            : {}),
                        missingFromApi: true,
                        missingFromApiAt,
        ...
        const currentRows = pollStates.map((observation) => {
            ...
            return {
                ...
                displayStatus: displayStatus(
                    ...
                    daily?.sawAvailable ??
                        observation.baseStatus === "available",
